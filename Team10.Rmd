...
UNION ALL
SELECT year(start_date) as Rok, COALESCE(contract_value, 0) as Kwota, 'Sponsoring' as Typ FROM sponsorship_contracts
UNION ALL
...
```
# Cztery dodatkowe pytania
## Jak miesiąc urodzenia chomika wpływa na wyniki?
```r{pytanie 4.1 miesiące}
df3 <- dbGetQuery(con, "
SELECT
